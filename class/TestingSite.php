<?php
    ...
    class TestingSite{
        ...
        public function addSite(){
            ...
            $this->test_site_id=htmlspecialchars(strip_tags($this->test_site_id));

            //bind to insert query
            $siteIn->bindParam(":location", $this->location);
            $siteIn->bindParam(":test_site_id", $this->test_site_id);
        ...
        public function getAllSites(){
            $readAll = "SELECT location, test_site_id FROM testing_site";
        ...
        public function getSite(){
            ...
            $this->test_site_id = $entry['test_site_id'];
        ...
        public function updateSite(){
            ...
            $site->bindParam(":test_site_id", $this->test_site_id);
